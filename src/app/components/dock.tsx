...
return (
    ...
    >
    {items.map((item) => (
        <IconContainer mouseX={mouseX} key={item.title} {...item} onClick={onItemClick} />
    ))}
    </motion.div>
);
};
...
return (
    <a href={href} onClick={e => { e.preventDefault(); onClick?.(title); }}>
    <motion.div
        ref={ref}
        style={{ width, height }}
    ...
    <AnimatePresence>
        ...
        >
            ...
            >
                ...
                onClick={e => { e.preventDefault(); onItemClick?.(item.title); }}
                >
